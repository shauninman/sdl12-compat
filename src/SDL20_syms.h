...
SDL20_SYM_PASSTHROUGH(void,MixAudioFormat,(Uint8 *a, const Uint8 *b, SDL_AudioFormat c, Uint32 d, int e),(a,b,c,d,e),)
SDL20_SYM_PASSTHROUGH(void,LockAudio,(void),(),)
SDL20_SYM_PASSTHROUGH(void,UnlockAudio,(void),(),)

SDL20_SYM_PASSTHROUGH(SDL_AudioStream *,NewAudioStream,(const SDL_AudioFormat a, const Uint8 b, const int c, const SDL_AudioFormat d, const Uint8 e, const int f),(a,b,c,d,e,f),return)
SDL20_SYM_PASSTHROUGH(int,AudioStreamPut,(SDL_AudioStream *a, const void *b, int c),(a,b,c),return)
SDL20_SYM_PASSTHROUGH(int,AudioStreamGet,(SDL_AudioStream *a, void *b, int c),(a,b,c),return)
SDL20_SYM_PASSTHROUGH(int,AudioStreamAvailable,(SDL_AudioStream *a),(a),return)
SDL20_SYM_PASSTHROUGH(int,AudioStreamFlush,(SDL_AudioStream *a),(a),return)
SDL20_SYM_PASSTHROUGH(void,AudioStreamClear,(SDL_AudioStream *a),(a),)
SDL20_SYM_PASSTHROUGH(void,FreeAudioStream,(SDL_AudioStream *a),(a),)
